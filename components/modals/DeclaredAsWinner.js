...
const DeclaredAsWinner = ({ declaredAsWInner, closeDeclareWinnerModal }) => {
    return (
        <div className={`${styles.modalWrapper} absolute top-0 left-0 right-0 bottom-0 z-20 flex justify-center items-center`}>
            ...
            <div className={`${styles.modalCard} ${declaredAsWInner == "blue" ? "bg-gradient-to-b from-blue-900 via-blue-700 to-blue-900" : declaredAsWInner == "red" ? "bg-gradient-to-b from-red-900 via-red-700 to-red-900" : "bg-gradient-to-b from-green-900 via-green-700 to-green-900"} relative text-white rounded-3xl border border-4 border-gray-300 p-4 drop-shadow-2xl`}>
                <div className={`${styles.modalTitleWinner} text-center font-bold`}>{declaredAsWInner.toUpperCase()}</div>
...
export default DeclaredAsWinner;